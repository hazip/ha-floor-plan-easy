...
export default {
  ...
  "toolbar.file.more_save": "More save options",
  "toolbar.file.more_open": "More open options",
  "toolbar.file.download": "Download as JSON",
  "toolbar.file.upload": "Upload from JSON",
  "toolbar.file.upload_failed": "Could not read this file. It is not a valid FloorPlan Easy export.",
